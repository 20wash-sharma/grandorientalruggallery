...
<!-- #EndLibraryItem --></td>
  ...
  <tr>
    ...
    <div class="wrap_slider1">
    	<img src="imgs/contact.jpg" width="944" height="200" border="0">    </div>
	...
	<div id="wrap_box2" style="width:450px;">
    <h1>Contact Us</h1>
	  ...
	  <p><strong style="font-weight:bold;">Grand Oriental Rug Gallery<br>
	    ...
	    Fax: 305.442.4502<br>
	    E-mail:</strong> <strong><a href="mailto:info@grandorientalruggallery.com" class="vm1" >info@grandorientalruggallery.com</a><br>
	    Web: <a href="http://www.contemporaryarearugsstore.com/" class="vm1" >www.grandorientalruggallery.com</a></strong></p>
       
        
        <h1 style="font-size:13px; color:#333333;"><strong>Contact Form </strong></h1>
	...
	<div id="wrap_box2" style="width:450px; float:right;">
    

	  <p><br>
	      <br>
        <img src="imgs/contact-img.jpg" width="370" height="536" class="pic"></p>
	  <div id="Loading" style="display:none; font-weight:bold;"><img src="imgs/loader.gif" border="0" style="padding-right:5px;">Sending, please wait...</div>
