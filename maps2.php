...
<!-- #EndLibraryItem --></td>
  ...
  <tr>
    ...
    <div class="wrap_slider1">
    	<img src="imgs/rugs/location.jpg" border="0">
    </div>
    ...
    <h1>Our Location</h1>
	  ...
	  <p><strong style="font-weight:bold;">Grand Oriental Rug Gallery<br>
	    ...
	    Web: <a href="http://www.contemporaryarearugsstore.com/" class="vm1" style="color:#000000;">www.grandorientalruggallery.com</a></strong></p>

    </div>
	<div id="location">
      <p><a href="maps.php" class="pic_box"><img src="imgs/location-map.jpg" border="0"></a></p>
      
      <p><a href="maps2.php" class="pic_box"><img src="imgs/location-map-2.jpg" border="0"></a></p>
	  </div>
