...
<!-- #EndLibraryItem --></td>
  ...
  <tr>
    ...
    <div class="wrap_slider1">
    	<img src="imgs/rugs/products.jpg" border="0">
    </div>
	...
	<div id="wrap_box2">
    <h1>Oriental Rug Gallery Products</h1>
	<p>Oriental Rugs are one of a kind.  To display the majority of all our sizes, designs and colors,  we&rsquo;ve created several broad categories for the web, but encourage you to come to our location for a more detailed look into our stunning products.   As importer/exporter rug specialists, rest assured we&rsquo;ll help you select the perfect piece tailored to your tastes, personality and d&eacute;cor.</p>

            	<ul id="prd">
                	<li><a href="index.php" title="modern area rugs">Contemporary Area Rugs</a></li>
                    <li><a href="index.php" title="custom area rugs">Persian Rugs</a></li>
                    <li><a href="index.php" title="shag rugs">Traditional & Transitional Rugs</a></li>
                    <li><a href="index.php" title="wool rugs">Tribal Rugs</a></li>
                    <li><a href="index.php" title="round wool area rugs">Tibetan Rugs</a></li>
                    <li><a href="index.php" title="tapestries">Hanging Tapestries</a></li>
                    <li><a href="index.php" title="persian rugs">Aubusson</a></li>
                    <li><a href="index.php" title="shag rugs in miami">Shag Rugs and Kilim ottoman</a></li>
                    <li><a href="index.php" title="florida area rugs">Rug pads - Carpet pads</a></li>
                </ul>
