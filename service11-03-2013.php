...
<title>Carpet Cleaning Miami, Rug - Carpet Repair & Cleaning Service In Miami Area,</title>
<META NAME='DESCRIPTION' CONTENT='Carpet Cleaning Miami, Rug Repair, Carpet Repair, Carpet Cleaning Service In Miami Area, Oriental Rug Cleaning Service, Carpet Cleaning Miami, Rug Repair, Carpet Repair, Carpet Cleaning Service In Miami Area, Oriental Rug Cleaning Service'>
<META NAME='Keywords' CONTENT='carpet cleaning miami, rug repair, carpet repair, carpet cleaning service in miami area, oriental rug cleaning service'>
...
<!-- #EndLibraryItem --></td>
  ...
  <tr>
	...
	<div id="wrap_box2" style="width:940px;">
    <h1>Carpet Cleaning Miami. Your Complete Carpet Cleaning And Repairs In Miami Coral Gables.</h1><div class="pic"> 
	  <div align="center">
	    <h2>
	      <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="400" height="292">
	        ...
	        <!--[if !IE]>-->
	        <object type="application/x-shockwave-flash" data="video/video.swf" width="400" height="292">
	          <!--<![endif]-->
	          <param name="quality" value="high">
	          <param name="wmode" value="opaque">
	          <param name="swfversion" value="6.0.65.0">
	...
	<p><img src="imgs/rug-interior.jpg" border="0" class="pic">The custom built vibrating massager gently loosen the deep down dirt out of both the front and back of your rug. The Rug is then totally soaked and submerged-in a cool water, along with the mild organic shampoo- process breaks down and flushes out all impurities, and any deep down dirt and dust that are trapped in the Rugs fiber and foundation. now its time for the total submersion rinse. A purified water is used in rinsing process. The Rug has to be prepared for drying process-after excess amount of water is squeezed out-  The Rug is now left drying on a blocking table that is more suitable for Rugs prone to losing their shape when wet. The final steps are carefully measured, the Process includes brushing the Rug and the fringes is very important component of the Rug, because it's the extension of the warp threads, that makes the foundation of the Rug.</p>
	<h1>Restorations and repair service</h1>
    <p><strong>Re-fringe:</strong> The fringe is hand sewn and there are many different  type  to choose from, so it looks original and matching.</p>
    <p><strong>Binding:</strong> it stops the rug from unraveling and fraying.</p>
    <p><strong>Overcasting:</strong> The side finish on rugs may detach from the rug, wear  down from traffic, get chewed off by pets.</p>
    <p><strong>Serging:</strong> for finish off certain type of rugs the yarn is serge around the  border which gives the rug a finished look and stops from unraveling.</p>
    <p><strong>Lock-stitching:</strong> Stops rugs from unraveling which can cause major damages  and lower the value of antique rugs. A neatly, and nearly invisible stitch  is sewn back and forth from end to end.  Appraisals.  Trade Ins, welcome.</p>
    <p><strong class="hl">Pick up and delivery service available.</strong></p>
    <div class="clear">&nbsp;</div>
    <p><strong class="ph">Call For a Free Quote today 305.442.4500 - 305.490.1936</strong></p>
	</div>
  ...
  <tr>
    ...
    <div class="clear">&nbsp;</div>
    <div id="footer_c">
        <a href="http://www.contemporaryarearugsstore.com/" target="_blank">Oriental Rugs</a> | 
        <a href="http://www.contemporaryarearugsstore.com/" target="_blank">Area Rugs</a> | 
        <a href="http://www.contemporaryarearugsstore.com/" target="_blank">Contemporary Rugs</a> | 
        <a href="http://www.contemporaryarearugsstore.com/" target="_blank">Persian Rugs Miami</a> | 
